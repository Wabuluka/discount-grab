...
const ORDER_STATUSES = [
  ...
  { value: "confirmed", label: "Confirmed", color: "bg-blue-50 text-blue-700 border-blue-200", icon: "check" },
  { value: "processing", label: "Processing", color: "bg-purple-50 text-purple-700 border-purple-200", icon: "cog" },
  { value: "shipped", label: "Shipped", color: "bg-indigo-50 text-indigo-700 border-indigo-200", icon: "truck" },
  { value: "delivered", label: "Delivered", color: "bg-emerald-50 text-emerald-700 border-emerald-200", icon: "check-circle" },
  { value: "cancelled", label: "Cancelled", color: "bg-red-50 text-red-700 border-red-200", icon: "x" },
];
...
const PAYMENT_STATUSES = [
  ...
  { value: "refunded", label: "Refunded", color: "bg-slate-50 text-slate-700 border-slate-200" },
];
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="px-4 py-2 bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl border border-cyan-100">
            <span className="text-cyan-600 font-semibold text-lg">{totalOrders}</span>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white rounded-2xl border border-slate-100 p-5 hover:shadow-lg hover:shadow-amber-100/50 transition-all group">
          <div className="flex items-center gap-3">
            <div className="p-3 bg-gradient-to-br from-amber-100 to-amber-50 rounded-xl group-hover:scale-110 transition-transform">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-5 hover:shadow-lg hover:shadow-indigo-100/50 transition-all group">
          <div className="flex items-center gap-3">
            <div className="p-3 bg-gradient-to-br from-indigo-100 to-indigo-50 rounded-xl group-hover:scale-110 transition-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-14 pr-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 outline-none transition-all bg-slate-50 focus:bg-white"
            />
          </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-sm">
              ...
              {orderLoading ? (
                ...
                filteredOrders.map((order, idx) => (
                  <tr key={order._id} className="hover:bg-gradient-to-r hover:from-slate-50 hover:to-transparent transition-all group">
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-white font-bold text-sm ${
                          idx % 4 === 0 ? "bg-gradient-to-br from-cyan-400 to-blue-500" :
                          idx % 4 === 1 ? "bg-gradient-to-br from-purple-400 to-indigo-500" :
                    ...
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-slate-200 to-slate-100 flex items-center justify-center text-slate-600 font-semibold text-sm">
        ...
        {/* Pagination */}
        {totalPages > 1 && (
          <div className="px-6 py-4 border-t border-slate-100 bg-gradient-to-r from-slate-50 to-transparent flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl text-sm font-medium hover:from-cyan-600 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm hover:shadow-md"
              >
                Next
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <div className="p-6 border-b border-slate-100 bg-gradient-to-r from-slate-50 to-cyan-50/30">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-2xl shadow-lg shadow-cyan-200">
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-180px)] space-y-6">
              ...
              <div className="flex flex-wrap gap-3">
                <span className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold border ${getStatusColor(selectedOrder.orderStatus)}`}>
                  {getStatusIcon(selectedOrder.orderStatus)}
                  <span className="capitalize">{selectedOrder.orderStatus}</span>
                </span>
                <span className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold border ${getPaymentStatusColor(selectedOrder.paymentStatus)}`}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-slate-50 to-blue-50/30 rounded-2xl p-5 border border-slate-100">
                ...
                <div className="bg-gradient-to-br from-slate-50 to-purple-50/30 rounded-2xl p-5 border border-slate-100">
                  <div className="flex items-center gap-3 mb-4">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                <div className="p-4 bg-gradient-to-r from-slate-50 to-amber-50/30 border-b border-slate-100">
                  <div className="flex items-center gap-3">
                ...
                <table className="w-full">
                  <thead className="bg-slate-50">
                    <tr>
                      ...
                      <th className="px-5 py-3 text-center text-xs font-semibold text-slate-600 uppercase">Qty</th>
                      <th className="px-5 py-3 text-right text-xs font-semibold text-slate-600 uppercase">Price</th>
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {selectedOrder.items.map((item, index) => (
                      <tr key={index} className="hover:bg-slate-50 transition-colors">
                        ...
                        <td className="px-5 py-4 text-right text-gray-600">{formatAsCurrency(item.price)}</td>
                        <td className="px-5 py-4 text-right font-semibold text-gray-900">{formatAsCurrency(item.price * item.quantity)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              {/* Order Summary */}
              <div className="bg-gradient-to-br from-slate-50 to-emerald-50/30 rounded-2xl p-5 border border-slate-100">
                <div className="flex items-center gap-3 mb-4">
                ...
                <div className="max-w-xs ml-auto space-y-3">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-gray-900">{formatAsCurrency(selectedOrder.subtotal)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600 flex items-center gap-2">
                      Shipping
                      {selectedOrder.shippingCost === 0 && (
                        <span className="px-2 py-0.5 bg-emerald-100 text-emerald-700 text-xs font-semibold rounded-lg">FREE</span>
                      )}
                    </span>
                    <span className="font-medium text-gray-900">
                      {selectedOrder.shippingCost === 0 ? "Free" : formatAsCurrency(selectedOrder.shippingCost)}
                    </span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Tax</span>
                    <span className="font-medium text-gray-900">{formatAsCurrency(selectedOrder.tax)}</span>
                  </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  ...
                  {selectedOrder.paidAt && (
                    <div className="bg-emerald-50 rounded-xl p-3 border border-emerald-100">
                      ...
                      <p className="text-sm font-semibold text-emerald-700">{formatDate(selectedOrder.paidAt)}</p>
                    </div>
                  )}
                  {selectedOrder.confirmedAt && (
                    <div className="bg-blue-50 rounded-xl p-3 border border-blue-100">
                      <p className="text-xs text-blue-600 mb-1">Confirmed</p>
                      <p className="text-sm font-semibold text-blue-700">{formatDate(selectedOrder.confirmedAt)}</p>
                    </div>
                  )}
                  {selectedOrder.processingAt && (
                    <div className="bg-purple-50 rounded-xl p-3 border border-purple-100">
                      <p className="text-xs text-purple-600 mb-1">Processing</p>
                      <p className="text-sm font-semibold text-purple-700">{formatDate(selectedOrder.processingAt)}</p>
                    </div>
                  )}
                  {selectedOrder.shippedAt && (
                    <div className="bg-indigo-50 rounded-xl p-3 border border-indigo-100">
                      <p className="text-xs text-indigo-600 mb-1">Shipped</p>
                      <p className="text-sm font-semibold text-indigo-700">{formatDate(selectedOrder.shippedAt)}</p>
                    </div>
                  )}
                  {selectedOrder.deliveredAt && (
                    <div className="bg-emerald-50 rounded-xl p-3 border border-emerald-100">
                      <p className="text-xs text-emerald-600 mb-1">Delivered</p>
                      <p className="text-sm font-semibold text-emerald-700">{formatDate(selectedOrder.deliveredAt)}</p>
                    </div>
                  )}
                  {selectedOrder.cancelledAt && (
                    <div className="bg-red-50 rounded-xl p-3 border border-red-100">
                      <p className="text-xs text-red-600 mb-1">Cancelled</p>
                      <p className="text-sm font-semibold text-red-700">{formatDate(selectedOrder.cancelledAt)}</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            {/* Modal Footer */}
            <div className="p-6 border-t border-slate-100 bg-gradient-to-r from-slate-50 to-transparent flex justify-end gap-3">
              <button
                onClick={() => setSelectedOrder(null)}
