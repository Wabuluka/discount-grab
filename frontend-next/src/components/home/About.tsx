    ...
    <section id="about" className="py-24 md:py-32 bg-white dark:bg-slate-900">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold text-slate-900 dark:text-slate-100 mb-6 max-w-2xl mx-auto leading-snug">
        ...
        {/* Stats row */}
        <div className="flex justify-center items-center gap-12 md:gap-20 py-10 border-y border-slate-100 dark:border-slate-800">
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-semibold text-slate-900 dark:text-slate-100">10+</div>
            <div className="text-xs text-slate-400 mt-1 uppercase tracking-wide">Years</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-semibold text-slate-900 dark:text-slate-100">50K+</div>
            <div className="text-xs text-slate-400 mt-1 uppercase tracking-wide">Customers</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-semibold text-slate-900 dark:text-slate-100">99%</div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16">
          {[
            ...
            <div key={item.title} className="text-center">
              <h3 className="text-sm font-medium text-slate-900 dark:text-slate-100 mb-1">{item.title}</h3>
